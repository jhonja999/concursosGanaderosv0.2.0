    ...
    try {
      if (initialData?.id) {
        ...
        toast({
          ...
          description: "El concurso ha sido actualizado correctamente.",
        })
      } else {
        // Create new concurso
        ...
        toast({
          ...
          description: "El concurso ha sido creado correctamente.",
        })
      }
      ...
      toast({
        title: "Error",
        description: "Ocurrió un error al guardar el concurso.",
        variant: "destructive",
      })
    } finally {
      setIsLoading(false)
